...
/// by the compiler when you pass a string interpolation to the log APIs.
@frozen
public struct BackportedOSLogMessage :
...
@frozen
public struct BackportedOSLogArguments {
  ...
  public var rawArguments: [(value: () -> Any, privacy: BackportedOSLogPrivacy)]
  ...
  internal mutating func append(_ header: UInt8) {
    ...
    @_transparent
    @usableFromInline
    internal mutating func append(value: @escaping @autoclosure () -> Any, privacy: BackportedOSLogPrivacy) {
        rawArguments.append((value, privacy))
    }
