...
@usableFromInline
internal enum BackportedOSLogCollectionBound {
  case start
  case end
}

@frozen
public struct BackportedOSLogStringAlignment {
  ...
  @usableFromInline
  internal var anchor: BackportedOSLogCollectionBound
  ...
  internal init(
    ...
    anchor: BackportedOSLogCollectionBound = .end
  ) {
  ...
  public static func right(
    ...
    BackportedOSLogStringAlignment(minimumColumnWidth: columns, anchor: .end)
  }
  ...
  public static func left(
    ...
    BackportedOSLogStringAlignment(minimumColumnWidth: columns, anchor: .start)
  }
}
